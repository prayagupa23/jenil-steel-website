        ...
        <section className="contact-map-section">
          <div className="contact-map-inner">
            <div className="map-card-header">
              ...
              <h3 className="map-title-text">Visit Our Headquarters</h3>
            </div>
            
            <div className="map-iframe-wrapper">
              <iframe
                title="Jenil Steel Vatva GIDC Ahmedabad Location"
                src="https://maps.google.com/maps?q=Excel%20Plaza,%20Pant%20Nagar,%20Ghatkopar%20East,%20Mumbai,%20Maharashtra%20400075&t=&z=15&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
